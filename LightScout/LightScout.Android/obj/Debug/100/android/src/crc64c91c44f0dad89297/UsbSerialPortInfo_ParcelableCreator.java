...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Hoho.Android.UsbSerial.Util.UsbSerialPortInfo+ParcelableCreator, UsbSerialForAndroid", UsbSerialPortInfo_ParcelableCreator.class, __md_methods);
	}
	...
	public UsbSerialPortInfo_ParcelableCreator ()
	{
		...
		if (getClass () == UsbSerialPortInfo_ParcelableCreator.class)
			mono.android.TypeManager.Activate ("Hoho.Android.UsbSerial.Util.UsbSerialPortInfo+ParcelableCreator, UsbSerialForAndroid", "", this, new java.lang.Object[] {  });
	}
